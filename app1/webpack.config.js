...
const context = Repack.getContext();
const entry = Repack.getEntry();
const platform = Repack.getPlatform({fallback: process.env.PLATFORM || 'web'});
const minimize = !dev;
const devServer = Repack.getDevServerOptions();
devServer.hmr = STANDALONE ? devServer.hmr : false;
const reactNativePath = Repack.getReactNativePath();
...
module.exports = {
  ...
  plugins: [
     ...
     */
    new Repack.AssetsResolverPlugin({
      platform,
    }),
